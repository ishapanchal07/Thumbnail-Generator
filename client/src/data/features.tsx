...
export const featuresData: IFeature[] = [
    {
        ...
        description: "Our AI analysis video content to suggest the most clickable concepts.",
    },
    {
        icon: "/assets/thumb-icon.svg",
        title: "Eye-Chaching Designs",
        description: "Generate vibrant, high-contrast thumbnails that stand out in the feed.",
    },
    {
        icon: "/assets/shape-icon.svg",
        title: "Fully Editable",
        description: "Get fully layered designes you can tweak to perfection if needed.",
    },
];
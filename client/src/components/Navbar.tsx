        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    {
                        isLoggedIn ? <Link to='/my-generations' className="hover:text-pink-300 transition">My Generations</Link>
                ...
                <div className="flex items-center gap-2">
                    {isLoggedIn ? (
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:black top-6 right-0 pt-4">

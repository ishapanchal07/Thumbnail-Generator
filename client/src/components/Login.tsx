        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center">
                <form
                    ...
                    className="w-full sm:w-[350px] text-center bg-white/5 border border-white/10 rounded-2xl px-8 pb-6"
                >
                    ...
                    <button
                        type="submit"
                        className="mt-2 w-full h-11 rounded-full text-white bg-pink-600 hover:bg-indigo-500 transition"
                    >
                        {state === "login" ? "Login" : "Sign up"}
                    </button>
